...
(defvar kirill/default-font-size 140)
(defvar kirill/default-variable-font-size 140)
...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (doom-modeline all-the-icons doom-themes visual-fill-column use-package markdown-mode impatient-mode))))
(custom-set-faces
